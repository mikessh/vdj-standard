...
try:
    ...
    sys.exit('Please install setuptools before installing airr_vdj.\n')

try:
    from pip.req import parse_requirements
except ImportError:
    sys.exit('Please install pip before installing airr_vdj.\n')

# Get version, author and license information
info_file = os.path.join('airr_vdj', 'version.py')
...
setup(name='repsum',
      ...
      download_url='https://github.com/airr-community/vdj-standard.git',
      keywords='AIRR bioinformatics immunoglobulin lymphocyte sequencing TCR CDR3',
      install_requires=install_requires,
      packages=['airr_vdj'],
      package_dir={'airr_vdj': 'airr_vdj'},
      entry_points={
		'console_scripts': [
        	'airr_vdj=airr_vdj.vdj_data:main'
    	],
	  },
      #scripts=scripts,
